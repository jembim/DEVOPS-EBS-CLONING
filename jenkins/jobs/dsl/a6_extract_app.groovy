...
def createJob = freeStyleJob(containerFolder + '/Extract_APP_Archives')
...
createJob.with {
    ...
    steps {
        ...
        copyArtifacts('Download_APP_Artifacts') {
            includePatterns('**/*')
...
ansible-playbook -i target-host --private-key=${CUSTOM_WORKSPACE}/${SSH_KEY} -u opc --become --become-user root -e "target=ebs app_run_dir=${APP_RUN_EDITION_DIR}" --tags "extract_app" site.yml
